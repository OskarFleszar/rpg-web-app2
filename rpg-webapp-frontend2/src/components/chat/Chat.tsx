      ...
      <div className={`chat-container ${isOpen ? "open" : ""}`}>
        ...
        <div className="chat-input-section">
          ...
          <div className="roll-controls-row">
            <div className="roll-controls-top-row">
            ...
            <div className="roll-controls-bottom-row">
              <div className="single-input-container">
                <p className="input-label">Dice type</p>
                <select
                  name="rollType"
                  value={
                    rollData.rollFor !== "Other" ? "d100" : rollData.rollType
                  }
              ...
              <div className="single-input-container">
                ...
                <input
                  ...
                  value={
                    rollData.rollFor !== "Other" ? 1 : rollData.numberOfDice
                  }
                  disabled={rollData.rollFor !== "Other"}
                  name="numberOfDice"
